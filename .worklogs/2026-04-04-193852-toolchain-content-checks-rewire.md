...
**Scope:** `packages/g3-toolchain-content-checks/**`, `apps/guardrail3/crates/app/rs/families/toolchain/crates/runtime/**`, `apps/guardrail3/Cargo.lock`

## Summary
Created the extracted `g3-toolchain-content-checks` package for toolchain content validation and rewired the in-app toolchain family to delegate `RS-TOOLCHAIN-02` and `RS-TOOLCHAIN-03` into it. The app still owns discovery, placement, legacy-file behavior, and result aggregation; the package now owns pure content semantics for channel/components and MSRV consistency.
...
- **Chose:** `packages/g3-toolchain-content-checks`
...
- **Chose:** leave `RS-TOOLCHAIN-01` and `RS-TOOLCHAIN-04` in the app family and bridge only `RS-TOOLCHAIN-02` and `RS-TOOLCHAIN-03`.
...
- package owns pure content semantics for `RS-TOOLCHAIN-02` and `RS-TOOLCHAIN-03`
...
- `apps/guardrail3/crates/app/rs/families/toolchain/crates/runtime/src/rs_toolchain_02_channel_and_components/rule.rs`
- `apps/guardrail3/crates/app/rs/families/toolchain/crates/runtime/src/rs_toolchain_03_msrv_consistency/rule.rs`
...
- `packages/g3-toolchain-content-checks/Cargo.toml` — package workspace and facade setup
- `packages/g3-toolchain-content-checks/crates/types/src/lib.rs` — public extracted input contract
- `packages/g3-toolchain-content-checks/crates/runtime/src/run.rs` — package entrypoint
- `packages/g3-toolchain-content-checks/crates/runtime/src/rs_toolchain_02_channel_and_components/rule.rs` — extracted channel/components logic
- `packages/g3-toolchain-content-checks/crates/runtime/src/rs_toolchain_03_msrv_consistency/rule.rs` — extracted MSRV consistency logic
...
1. Decide whether to delete the now-retired in-app `rs_toolchain_02_channel_and_components/rule.rs` and `rs_toolchain_03_msrv_consistency/rule.rs` source files or keep them temporarily during extraction rollout.
