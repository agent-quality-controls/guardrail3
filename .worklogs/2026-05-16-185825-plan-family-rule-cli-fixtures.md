...
- Use `behavior/fixtures/g3rs-rules/<family>/<fixture-id>/fixture.toml`.
...
- Add `scripts/behavior/verify-family-rule-fixtures.py`.
- Add cargo fixtures under `behavior/fixtures/g3rs-rules/cargo`.
