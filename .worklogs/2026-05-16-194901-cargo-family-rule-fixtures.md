Summary:
Added the first minimized family-rule fixture set under `behavior/fixtures/g3rs-rules/cargo`. Cargo now has one clean golden fixture and two broken-layer fixtures that expose CLI-visible cargo rule behavior without relying on internal ingestion structs.
...
- Added `scripts/behavior/verify-family-rule-fixtures.py` to enforce fixture metadata, one clean golden per family, known rule IDs, approved-output presence, and completed-family ledger coverage.
...
- `behavior/fixtures/g3rs-rules/cargo/cargo-R00-clean-golden/fixture.toml`
- `behavior/fixtures/g3rs-rules/cargo/cargo-R10-policy-violations/fixture.toml`
- `behavior/fixtures/g3rs-rules/cargo/cargo-R21-root-metadata-missing/fixture.toml`
