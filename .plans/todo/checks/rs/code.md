...
| RS-CODE-07 | R36 | Warn | EXCEPTION comments in config files (audit trail inventory) | Implemented |
...
| RS-CODE-35 | Error | Per-crate source tree exceeds structural caps: module depth >6, sibling subdirectories >12, or sibling `.rs` files >20 in one Rust source directory. | Dropped |
