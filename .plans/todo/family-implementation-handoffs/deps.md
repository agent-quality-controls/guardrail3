...
- target-specific dependency tables are still outside `RS-DEPS-05..07`
- `RS-DEPS-12` explicitly owns target-specific direct-dependency counting

## Scope You Own

This lane owned:

- implementing `RS-DEPS-12`
...
- a broad rewrite of `RS-DEPS-05..11`
...
- one rule file for `RS-DEPS-12`
- rule-specific sidecar tests

Do not:

- collapse the rule into `RS-DEPS-05..07`
...
2. `RS-DEPS-12` was added as a dedicated rule file
...
- target-table ownership is explicit: counted for `RS-DEPS-12`, still out of scope for `RS-DEPS-05..07`
