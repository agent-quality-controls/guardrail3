...
- `behavior/fixtures/g3rs-rule` is the family-specific rule fixture suite.
...
- `scripts/behavior/verify-g3rs-family-rule-fixtures.py` and `scripts/behavior/verify-g3rs-rule-fixture-coverage.py` now prove family rule coverage through `g3rs-rule`.
...
5. Keep `g3rs-validate-repo`, `g3rs-cli-output`, and `g3rs-rule`.
6. Run:
...
- Do not delete `behavior/fixtures/g3rs-rule`.
