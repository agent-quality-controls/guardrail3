pub fn assert_modern_only(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::rs_toolchain_filetree_01_exists::assert_findings(
        results,
        &[crate::rs_toolchain_filetree_01_exists::info(
    ...
    crate::rs_toolchain_filetree_04_legacy_file::assert_findings(results, &[]);
}

pub fn assert_legacy_only_without_modern(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::rs_toolchain_filetree_01_exists::assert_findings(
        results,
        &[crate::rs_toolchain_filetree_01_exists::error(
    ...
    crate::rs_toolchain_filetree_04_legacy_file::assert_findings(
        results,
        &[crate::rs_toolchain_filetree_04_legacy_file::warn(
...
pub fn assert_both_files_present(results: &[guardrail3_check_types::G3CheckResult]) {
    ...
    crate::rs_toolchain_filetree_04_legacy_file::assert_findings(
        results,
        &[crate::rs_toolchain_filetree_04_legacy_file::error(
