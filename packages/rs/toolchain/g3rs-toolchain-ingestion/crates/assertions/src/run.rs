pub fn assert_missing_modern_toolchain(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_toolchain_filetree_checks_assertions::exists::assert_findings(
        results,
        &[g3rs_toolchain_filetree_checks_assertions::exists::error(
...
pub fn assert_legacy_only_without_modern(results: &[guardrail3_check_types::G3CheckResult]) {
    ...
    g3rs_toolchain_filetree_checks_assertions::legacy_file::assert_findings(
        results,
        &[
            g3rs_toolchain_filetree_checks_assertions::legacy_file::warn(
...
pub fn assert_both_toolchain_files_present(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_toolchain_filetree_checks_assertions::exists::assert_findings(
        results,
        &[g3rs_toolchain_filetree_checks_assertions::exists::info(
    ...
    g3rs_toolchain_filetree_checks_assertions::legacy_file::assert_findings(
        results,
        &[
            g3rs_toolchain_filetree_checks_assertions::legacy_file::error(
...
pub fn assert_modern_toolchain_exists(results: &[guardrail3_check_types::G3CheckResult]) {
    ...
    g3rs_toolchain_filetree_checks_assertions::legacy_file::assert_findings(results, &[]);
}

pub fn assert_nightly_toolchain_channel(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_toolchain_config_checks_assertions::channel_and_components::rule::assert_contains(
        results,
        g3rs_toolchain_config_checks_assertions::channel_and_components::rule::error(
