use g3rs_code_source_checks_assertions::fs_glob_import::rule::assert_rule_results;
...
fn skips_grouped_non_fs_std_glob_imports() {
    ...
    assert_rule_results(
        &super::super::check_source("src/foo.rs", direct, false),
        &[],
    );
    assert_rule_results(
        &super::super::check_source("src/foo.rs", aliased, false),
        &[],
    );
}
