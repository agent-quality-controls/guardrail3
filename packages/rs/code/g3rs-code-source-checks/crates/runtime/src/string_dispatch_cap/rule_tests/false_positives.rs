...
use g3rs_code_source_checks_assertions::string_dispatch_cap::rule::assert_rule_results;
...
fn skips_small_sites_and_test_contexts() {
    ...
    assert_rule_results(
        &super::super::check_source("src/lib.rs", small_match, false),
        &[],
    );
    assert_rule_results(
        &super::super::check_source("src/lib.rs", test_only_dispatch, false),
        &[],
    );
    assert_rule_results(
        &super::super::check_source("src/lib.rs", mixed_chain, false),
        &[],
    );
}
...
fn skips_sites_at_the_exact_string_dispatch_cap() {
    ...
    assert_rule_results(
        &super::super::check_source("src/lib.rs", &exact_match, false),
        &[],
    );
    assert_rule_results(
        &super::super::check_source("src/lib.rs", &exact_chain, false),
        &[],
    );
}
