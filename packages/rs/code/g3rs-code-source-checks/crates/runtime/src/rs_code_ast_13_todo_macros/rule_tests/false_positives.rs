use g3rs_code_source_checks_assertions::rs_code_ast_13_todo_macros::rule::assert_rule_results;

#[test]
fn skips_unreachable_macro_in_test_owned_files() {
    let results = super::super::check_source("tests/foo.rs", "fn foo() { unreachable!(); }", true);
