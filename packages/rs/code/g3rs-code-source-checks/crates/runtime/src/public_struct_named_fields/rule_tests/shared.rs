use g3rs_code_source_checks_assertions::public_struct_named_fields::rule::{
...
#[test]
fn shared_nested_public_struct_with_super_reexport_alias_impl_still_errors() {
    let results = super::super::check_source_with_shared(
        "src/types.rs",
...
#[test]
fn shared_nested_public_struct_with_reversed_alias_binding_order_still_errors() {
    let results = super::super::check_source_with_shared(
        "src/types.rs",
