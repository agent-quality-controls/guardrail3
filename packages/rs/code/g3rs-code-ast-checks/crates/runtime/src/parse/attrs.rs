...
pub(crate) fn find_public_result_error_types(ast: &syn::File) -> Vec<PublicResultErrorInfo> {
...
pub(crate) fn find_public_struct_field_bags(ast: &syn::File) -> Vec<PublicStructFieldBagInfo> {
