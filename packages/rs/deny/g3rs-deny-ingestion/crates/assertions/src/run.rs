pub fn assert_missing_graph_section(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_deny_config_checks_assertions::advisories::rs_deny_config_05_graph_no_default_features::rule::assert_findings(
        results,
        &[g3rs_deny_config_checks_assertions::advisories::rs_deny_config_05_graph_no_default_features::rule::error(
...
pub fn assert_missing_deny_config(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::assert_findings(
        results,
        &[g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::error_no_file(
...
pub fn assert_selected_root_deny_config(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::assert_findings(
        results,
        &[g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::info(
    ...
    g3rs_deny_filetree_checks_assertions::rs_deny_filetree_03_shadowing::assert_no_findings(results);
}
...
pub fn assert_same_root_conflicts(results: &[guardrail3_check_types::G3CheckResult]) {
    ...
    g3rs_deny_filetree_checks_assertions::rs_deny_filetree_03_shadowing::assert_findings(
        results,
        &[g3rs_deny_filetree_checks_assertions::rs_deny_filetree_03_shadowing::error(
...
pub fn assert_selected_deny_parse_failures(results: &[guardrail3_check_types::G3CheckResult]) {
    g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::assert_findings(
        results,
        &[
            g3rs_deny_filetree_checks_assertions::rs_deny_filetree_01_coverage::error(
                "deny input failure",
