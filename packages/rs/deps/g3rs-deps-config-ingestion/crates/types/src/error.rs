...
/// Ingestion failure for deps config.
#[derive(Debug)]
pub enum G3RsDepsConfigIngestionError {
...
impl std::fmt::Display for G3RsDepsConfigIngestionError {
...
impl std::error::Error for G3RsDepsConfigIngestionError {}
