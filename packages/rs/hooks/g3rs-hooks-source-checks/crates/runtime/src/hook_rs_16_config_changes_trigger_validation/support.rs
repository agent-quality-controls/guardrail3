...
pub(super) fn missing_config_needles(parsed: &ParsedShellScript) -> Vec<&'static str> {
    let content = script_text(parsed);
...
fn script_text(parsed: &ParsedShellScript) -> String {
    parsed
        .source_lines
        .iter()
