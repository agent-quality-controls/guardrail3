pub fn assert_clean_root_coverage(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::rs_clippy_filetree_01_coverage_exists::rule::assert_findings(
        results,
        &[crate::rs_clippy_filetree_01_coverage_exists::rule::info(
    ...
    crate::rs_clippy_filetree_02_same_root_conflict::rule::assert_no_findings(results);
}
...
pub fn assert_missing_root(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::rs_clippy_filetree_01_coverage_exists::rule::assert_findings(
        results,
        &[crate::rs_clippy_filetree_01_coverage_exists::rule::error(
