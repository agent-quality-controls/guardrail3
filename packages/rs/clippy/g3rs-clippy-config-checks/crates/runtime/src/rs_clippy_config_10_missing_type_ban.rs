...
use crate::support::{
    expected_required_type_bans, garde_enabled, parse_ban_section, raw_clippy, rust_policy_valid,
};

const ID: &str = "RS-CLIPPY-CONFIG-10";
...
#[cfg(test)]
#[path = "rs_clippy_config_10_missing_type_ban_tests/mod.rs"] // reason: owned sidecar tests for file module.
