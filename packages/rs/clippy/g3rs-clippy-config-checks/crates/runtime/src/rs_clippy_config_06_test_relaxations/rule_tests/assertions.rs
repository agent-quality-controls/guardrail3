...
use crate::test_support::{Finding, assert_findings_for, error_for, info_for, warn_for};
...
pub(super) fn warn(title: &str, message: &str, file: &str, inventory: bool) -> Finding {
    warn_for(ID, title, message, file, inventory)
}
