pub fn assert_missing_root(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::exists::rule::assert_findings(
        results,
        &[crate::exists::rule::error(
    ...
    crate::per_crate_override::rule::assert_no_findings(results);
    crate::dual_file_conflict::rule::assert_no_findings(results);
}

pub fn assert_root_conflict(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::exists::rule::assert_no_findings(results);
    crate::per_crate_override::rule::assert_no_findings(results);
    crate::dual_file_conflict::rule::assert_findings(
        results,
        &[crate::dual_file_conflict::rule::warn(
...
pub fn assert_nested_override(results: &[guardrail3_check_types::G3CheckResult]) {
    crate::exists::rule::assert_no_findings(results);
    crate::per_crate_override::rule::assert_findings(
        results,
        &[crate::per_crate_override::rule::error(
