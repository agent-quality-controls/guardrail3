...
/// Ingestion failure for release config.
#[derive(Debug)]
pub enum G3RsReleaseConfigIngestionError {
...
impl std::fmt::Display for G3RsReleaseConfigIngestionError {
...
impl std::error::Error for G3RsReleaseConfigIngestionError {}
