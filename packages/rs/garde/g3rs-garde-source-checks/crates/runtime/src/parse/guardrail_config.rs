...
fn collect_validate_call_receivers(block: &syn::Block) -> BTreeMap<String, Vec<usize>> {
    ...
    impl<'source> syn::visit::Visit<'source> for ValidateCallVisitor {
        ...
        fn visit_item_fn(&mut self, _item: &'source syn::ItemFn) {}

        fn visit_item_mod(&mut self, _item: &'source syn::ItemMod) {}
    }
...
fn collect_non_validate_use_lines(block: &syn::Block) -> BTreeMap<String, Vec<usize>> {
    ...
    impl<'source> syn::visit::Visit<'source> for NonValidateUseVisitor {
        ...
        fn visit_expr_assign(&mut self, expr: &'source syn::ExprAssign) {
