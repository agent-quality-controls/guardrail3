...
- The package currently assumes the app is still the sole owner of malformed-input reporting through `RS-GARDE-SOURCE-10`. Unreadable or unparsable source files are skipped here rather than producing package-local findings.
