...
use g3rs_test_source_checks_assertions::ignore_reason::rule as assertions;
...
fn accepts_previous_line_and_inline_ignore_reasons() {
    ...
    assertions::assert_title_count(&results, "g3rs-test/ignore-reason", "ignored test count", 1);
}
