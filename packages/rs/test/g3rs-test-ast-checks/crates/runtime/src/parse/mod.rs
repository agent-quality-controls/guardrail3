...
pub(crate) type IgnoreReasonInfo = self::types::IgnoreReasonInfo;
pub(crate) type ModuleInfo = self::types::ModuleInfo;
pub(crate) type ParsedTestFile = self::types::ParsedTestFile;
pub(crate) type PublicValueInfo = self::types::PublicValueInfo;
pub(crate) type PublicValueKind = self::types::PublicValueKind;
pub(crate) type ReturnKind = self::types::ReturnKind;
pub(crate) type TestFunctionInfo = self::types::TestFunctionInfo;
pub(crate) type UseBinding = self::types::UseBinding;
...
pub(crate) fn analyze(ast: &syn::File, content: &str) -> ParsedTestFile {
    let check_result_aliases = collect_check_result_aliases(ast);
    let mut visitor = TestVisitor {
        out: ParsedTestFile {
            ignore_reasons: find_ignore_reasons(ast, content),
            modules: Vec::new(),
