use g3rs_apparch_config_checks_assertions::same_layer_cycles as assertions;
use g3rs_apparch_types::{
    G3RsApparchLayer, G3RsApparchSameLayerCyclesChecksInput, G3RsApparchSameLayerDependencyEdge,
};
...
fn cycle_is_not_dropped_when_first_sorted_node_is_missing_from_crate_bag() {
    ...
    crate::same_layer_cycles::check(&input, &mut results);
