...
use nextest_toml_parser::{NextestProfile, NextestToml, TimeoutConfig, Value};
...
pub fn parse_error(input: &str) -> Result<NextestToml, nextest_toml_parser::Error> {
    nextest_toml_parser::parse(input)
}
