...
use g3rs_toolchain_config_checks_types::G3RsToolchainConfigMsrvConsistencyInput;
use guardrail3_check_types::G3CheckResult;
use rust_toolchain_toml_parser::parse as parse_toolchain_toml;

use crate::rs_toolchain_config_02_msrv_consistency::check;
...
pub(super) fn run_check(toolchain_toml: &str, cargo_toml: &str) -> Vec<G3CheckResult> {
    ...
    let input = G3RsToolchainConfigMsrvConsistencyInput {
