...
test("no-direct-astro-content-in-routes only fires on direct route imports", async () => {
  const project = await createFixtureProject({
    ...
    `,
    "src/pages/data-ts-wrapper.endpoint.ts": `
      export async function GET() {
        const source = "astro:content" as const;
        return await import(source);
      }
    `,
    "src/pages/data-satisfies.endpoint.ts": `
      export async function GET() {
        const source = "astro:" + "content" satisfies string;
        return await import(source);
      }
    `,
    "src/pages/data-static-concat.endpoint.ts": `
      export async function GET() {
        return await import("astro:" + "content");
      }
    `,
    "src/pages/data-template.endpoint.ts": `
      export async function GET() {
        const namespace = "astro";
        return await import(\`\${namespace}:content\`);
      }
    `,
    ...
    `,
    "src/pages/data-require-static-concat.endpoint.ts": `
      export async function GET() {
        const { getCollection } = require("astro:" + "content");
        return await getCollection("posts");
      }
  ...
  try {
    ...
    tester.run("astro-pipeline/no-direct-astro-content-in-routes", rule, {
      ...
      invalid: [
        ...
        {
          code: await project.read("src/pages/data-ts-wrapper.endpoint.ts"),
          filename: project.path("src/pages/data-ts-wrapper.endpoint.ts"),
          options: [baseOptions],
          errors: [
            {
              messageId: "forbiddenImport"
        ...
        {
          code: await project.read("src/pages/data-satisfies.endpoint.ts"),
          filename: project.path("src/pages/data-satisfies.endpoint.ts"),
          options: [baseOptions],
          errors: [
            {
              messageId: "forbiddenImport"
        ...
        {
          code: await project.read("src/pages/data-static-concat.endpoint.ts"),
          filename: project.path("src/pages/data-static-concat.endpoint.ts"),
          options: [baseOptions],
          errors: [
            {
              messageId: "forbiddenImport"
        ...
        {
          code: await project.read("src/pages/data-template.endpoint.ts"),
          filename: project.path("src/pages/data-template.endpoint.ts"),
          options: [baseOptions],
          errors: [
            {
              messageId: "forbiddenImport"
        ...
        {
          code: await project.read("src/pages/data-require-static-concat.endpoint.ts"),
          filename: project.path("src/pages/data-require-static-concat.endpoint.ts"),
          options: [baseOptions],
          errors: [
            {
              messageId: "forbiddenImport"
