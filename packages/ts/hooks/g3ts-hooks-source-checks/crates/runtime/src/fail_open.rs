use g3ts_hooks_contract_types::G3TsHookCriticalCommand;
...
pub(crate) fn first_fail_open_critical_command(
...
pub(crate) fn critical_command_names(input: &G3TsHooksSourceChecksInput) -> Vec<String> {
    let mut names = input
        .requirements()
        .iter()
        .flat_map(g3ts_hooks_contract_types::G3TsHookRequirement::critical_commands)
