...
use g3ts_astro_types::{
    G3TsAstroCallSnapshot, G3TsAstroIntegrationSnapshot, G3TsAstroOutputMode,
    G3TsAstroStaticObjectProperty, G3TsAstroStaticValue,
};

pub fn ingest_astro_config_surface(
