...
const ID: &str = "TS-ASTRO-CONTENT-CONFIG-17";
...
pub(crate) fn check(
    ...
    results.push(crate::support::error(
        ...
        format!(
            "`{}` must list `{DEPENDENCY_NAME}` in dependencies or devDependencies. Astro content boundary checks are delegated to that ESLint plugin; setup checks do not own this package.",
