...
pub(crate) fn check(
    ...
    results.push(crate::support::error(
        ...
        format!(
            "`{}` must install `{PACKAGE_NAME}` in dependencies or devDependencies. G3TS delegates ESLint directive policy to that package instead of parsing comments itself.",
