...
pub(crate) fn ingest_i18n_policy_surface(
    ...
    G3TsAstroI18nPolicySurfaceState::Parsed {
        snapshot: G3TsAstroI18nPolicySnapshot {
            ...
            content_image_components: i18n.content_image_components,
            content_image_key_props: i18n.content_image_key_props,
            banned_image_source_props: i18n.banned_image_source_props,
            banned_image_alt_props: i18n.banned_image_alt_props,
