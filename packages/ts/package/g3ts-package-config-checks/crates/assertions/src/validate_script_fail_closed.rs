...
/// Assert that running the runtime on `input` produces a fail-open validate error.
///
/// # Panics
...
/// Assert that running the runtime on `input` produces a fail-closed validate inventory entry.
///
/// # Panics
/// Panics if the expected inventory is missing.
...
/// Assert `results` contains the expected fail-open validate error.
///
/// # Panics
/// Panics if the expected error is missing.
...
/// Assert `results` contains the expected fail-closed validate inventory entry.
///
/// # Panics
/// Panics if the expected entry is missing.
