...
- `RS-GARDE-09` depends on legacy `guardrail3.toml` escape hatches. If the garde family migrates that policy surface later, the package contract should switch to the new parsed policy file deliberately.
