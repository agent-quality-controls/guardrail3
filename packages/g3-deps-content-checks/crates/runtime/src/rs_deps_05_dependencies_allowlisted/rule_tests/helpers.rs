...
use g3_deps_content_checks_types::{G3DepsLocalPathCargoManifest, G3DepsPolicyContentChecksInput};
use guardrail3_check_types::G3CheckResult;
use guardrail3_domain_config::types::GuardrailConfig;

use crate::rs_deps_05_dependencies_allowlisted::rule::check;
...
pub(super) fn run_check_with_local_paths(
    ...
    let input = G3DepsPolicyContentChecksInput {
        ...
        local_path_cargo_manifests: local_path_cargo_manifests
            .iter()
            .map(|(cargo_rel_path, cargo_toml)| G3DepsLocalPathCargoManifest {
