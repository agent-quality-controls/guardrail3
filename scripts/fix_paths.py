...
NEW_LOCATIONS = {
    ...
    "g3rs-cargo-config-ingestion": "packages/rs/cargo/g3rs-cargo-config-ingestion",
    "g3rs-clippy-config-checks": "packages/rs/clippy/g3rs-clippy-config-checks",
    "g3rs-clippy-config-ingestion": "packages/rs/clippy/g3rs-clippy-config-ingestion",
    "g3rs-deny-config-checks": "packages/rs/deny/g3rs-deny-config-checks",
    "g3rs-deny-config-ingestion": "packages/rs/deny/g3rs-deny-config-ingestion",
    ...
    "g3rs-fmt-config-ingestion": "packages/rs/fmt/g3rs-fmt-config-ingestion",
    ...
    "g3rs-garde-config-ingestion": "packages/rs/garde/g3rs-garde-config-ingestion",
    "g3rs-release-config-checks": "packages/rs/release/g3rs-release-config-checks",
    "g3rs-release-config-ingestion": "packages/rs/release/g3rs-release-config-ingestion",
    "g3rs-toolchain-config-checks": "packages/rs/toolchain/g3rs-toolchain-config-checks",
    "g3rs-toolchain-config-ingestion": "packages/rs/toolchain/g3rs-toolchain-config-ingestion",
}
