...
MANIFEST = REPO_ROOT / ".plans" / "2026-05-15-145757-fixture-contract-and-replay-audit.md.manifest.toml"
...
def verify() -> list[str]:
    ...
    kept_manifest = load_toml(
        REPO_ROOT / ".plans" / "2026-05-15-143306-g3rs-kept-test-disposition-audit.md.manifest.toml"
    )
    actual_dispositions = {
        str(row["name"]): int(row["expected_rows"])
