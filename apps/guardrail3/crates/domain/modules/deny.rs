...
pub fn build_deny_toml_with_entries(
    ...
    // Skip entries
    out.push_str("skip = [\n");
    let deduped_skip = crate::deduplicated_override(&out, extra_skip);
    ...
    let deduped_bans = crate::deduplicated_override(&out, extra_bans);
    ...
    let deduped_feature_bans = crate::deduplicated_override(&out, extra_feature_bans);
