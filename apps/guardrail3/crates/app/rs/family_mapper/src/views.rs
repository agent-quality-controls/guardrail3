...
// RsProjectSurface removed. Families receive FamilyView from legality output.
// See legacy/apps/guardrail3/crates/app/rs/family_mapper/src/views.rs for the old code.
