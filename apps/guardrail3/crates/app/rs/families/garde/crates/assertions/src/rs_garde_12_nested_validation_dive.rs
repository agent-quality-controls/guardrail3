crate::define_rule_assertions!("RS-GARDE-12");
...
pub fn assert_field_level_constraints_quiet(results: &[guardrail3_domain_report::CheckResult]) {
    crate::common::assert_rule_quiet(results, "RS-GARDE-11");
}
