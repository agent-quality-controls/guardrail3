use guardrail3_app_rs_family_deny_assertions::advisories::rs_deny_config_05_graph_no_default_features as assertions;
...
fn local_graph_no_default_features_drift_only_errors_for_the_owned_local_root() {
    let results = super::helpers::run_check(&set_section_bool(
