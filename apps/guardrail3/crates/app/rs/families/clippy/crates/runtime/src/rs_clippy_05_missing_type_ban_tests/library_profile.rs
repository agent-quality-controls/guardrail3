...
use test_support::{build_fixture_clippy_toml, published_library_package_root_tree, remove_ban_path};
...
fn does_not_double_report_library_global_state_gaps() {
    let mut clippy = build_fixture_clippy_toml("library", false, true, "", "");
