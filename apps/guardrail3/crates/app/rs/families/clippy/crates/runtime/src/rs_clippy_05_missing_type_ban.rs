...
use super::clippy_support::{expected_required_type_bans, parse_ban_section};
...
#[cfg(test)]
#[path = "rs_clippy_05_missing_type_ban_tests/mod.rs"] // reason: test-only sidecar module wiring
mod rs_clippy_05_missing_type_ban_tests;
