...
- shared Rust placement/legality substrate
...
- legality-aware workspace facts from the shared placement/legality substrate
...
- shared legality decides what Rust roots and policy roots are legal
...
- the runtime crate builds and the family is green on its own routed surface and under `RS-CLIPPY`
...
- the family runs on routed legality-approved workspaces without requiring the `topology` family to run
