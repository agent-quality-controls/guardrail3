...
pub fn check(input: &RustCodeFileInput<'_>, results: &mut Vec<CheckResult>) {
    ...
    results.push(CheckResult {
        ...
        title: "many use imports".to_owned(),
        message: format!("{use_count} top-level use imports (warn at 16, max 20)."),
...
#[cfg(test)]
#[path = "rs_code_11_use_count_warn_tests/mod.rs"] // reason: test-only sidecar module wiring
