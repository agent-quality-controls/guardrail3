    ...
    assert_findings(
        ...
        &[
            RuleFinding {
                ...
                title: "item-level expect with reason",
                message: "#[expect(clippy::unwrap_used)] reason: compatibility probe",
            ...
            RuleFinding {
                severity: Severity::Info,
                title: "item-level expect with reason",
                message: "#[expect(clippy::expect_used)] reason: grouped expectation surface",
            ...
            RuleFinding {
                severity: Severity::Info,
                title: "item-level expect with reason",
                message: "#[expect(clippy::unwrap_used)] reason: grouped expectation surface",
                file: Some(grouped_rel),
                line: Some(grouped_line),
                inventory: true,
            },
            RuleFinding {
                severity: Severity::Info,
                title: "item-level expect with reason",
                message: "#[expect(clippy::panic)] reason: documented extern-facing probe",
