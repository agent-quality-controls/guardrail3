...
#[test]
fn golden_layout_has_no_scoped_topology_errors() {
    ...
    assertions::assert_no_error_files(&results, "RS-TOPOLOGY-05");
    assertions::assert_inventory_summary(&results, "RS-TOPOLOGY-05", "topology config remains global-only");
}
