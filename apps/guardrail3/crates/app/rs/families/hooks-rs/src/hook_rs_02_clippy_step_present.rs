    ...
    if found {
        results.push(
            CheckResult::from_parts(
                ID.to_owned(),
                Severity::Warn,
                "cargo clippy step present".to_owned(),
                "Hook runs cargo clippy.".to_owned(),
        ...
        results.push(CheckResult::from_parts(
            ID.to_owned(),
            Severity::Warn,
            "cargo clippy step missing".to_owned(),
            "Hook does not execute cargo clippy.".to_owned(),
            Some(input.rel_path.to_owned()),
            None,
            false,
        ));
...
#[cfg(test)]
#[path = "tests/steps/hook_rs_02_clippy_step_present_tests/mod.rs"]
