...
use guardrail3_app_rs_family_test_assertions::rs_test_07_real_proof_site::{assert_reported_file, assert_reported, assert_rule_files, assert_rule_quiet};

#[allow(unused_imports)]
use super::{run_family, tempdir, write_file};

#[test]
fn same_named_function_in_other_assertions_module_does_not_count_as_proof() {let fixture = tempdir();
    ...
    assert_rule_files(&results, vec!["crates/runtime/src/foo_tests/proof.rs".to_owned()]
    );
