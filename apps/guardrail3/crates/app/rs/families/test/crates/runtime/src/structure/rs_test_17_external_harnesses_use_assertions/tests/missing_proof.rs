use guardrail3_app_rs_family_test_assertions::rs_test_17_external_harnesses_use_assertions::assert_rule_quiet;

use super::{run_family, tempdir, write_file};

#[test]
fn external_harness_without_owned_assertions_does_not_emit_false_inventory() {
    let fixture = tempdir();
    ...
    write_file(
        ...
        "#[test]\nfn public_surface() { let _ = demo_runtime::value(); }\n",
    );
    write_file(
        root,
