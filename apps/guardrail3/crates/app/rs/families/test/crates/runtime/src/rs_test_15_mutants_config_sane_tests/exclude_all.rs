...
#[test]
fn exclude_all_pattern_is_reported() {let fixture = tempdir();
    ...
    );    assert_reported(&results, ".cargo/mutants.toml", None, Severity::Warn, "mutants config excludes everything");
