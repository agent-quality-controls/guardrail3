use guardrail3_app_rs_family_release_assertions::publish_metadata::rs_pub_03_repository_present as assertions;

use super::helpers::check;
use super::helpers::{crate_facts, crate_input};

#[test]
fn errors_without_repository_and_skips_non_publishable_crates() {
    let mut missing = crate_facts("x");
    missing.repository_present = false;
    ...
    assertions::assert_rule_results(
        ...
        &[assertions::ExpectedRuleResult {
            ...
            title_contains: Some("repository"),
            message_contains: Some("repository"),
            ..Default::default()
        }],
    );
    ...
    non_publishable.repository_present = false;
