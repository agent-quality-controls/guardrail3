...
fn passes_when_toolchain_prefixed_clippy_command_exists() {
    let parsed = parsed_hook("cargo +nightly clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn passes_when_env_with_flag_wraps_cargo_clippy() {
    let parsed = parsed_hook("env -i cargo clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn passes_when_path_qualified_cargo_runs_clippy() {
    let parsed = parsed_hook("/Users/me/.cargo/bin/cargo clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn passes_when_path_qualified_toolchain_prefixed_cargo_runs_clippy() {
    let parsed = parsed_hook("/Users/me/.cargo/bin/cargo +nightly clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn passes_when_cargo_global_flag_precedes_clippy() {
    let parsed = parsed_hook("cargo --locked clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn passes_when_env_wraps_cargo_global_flag_clippy() {
    let parsed = parsed_hook("env -i cargo --locked clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn warns_when_clippy_only_appears_in_assignment_text() {
    let parsed = parsed_hook("CLIPPY_LABEL=\"cargo clippy --workspace\"\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn warns_when_clippy_only_appears_in_export_assignment() {
    let parsed = parsed_hook("export CLIPPY_CMD=\"cargo clippy --workspace\"\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn warns_when_near_match_clippy_subcommand_is_used() {
    let parsed = parsed_hook("cargo clippy-driver --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn warns_when_clippy_command_is_only_help() {
    let parsed = parsed_hook("cargo clippy --help\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
...
fn warns_when_cargo_global_help_precedes_clippy() {
    let parsed = parsed_hook("cargo --help clippy --workspace\n");
    let input = RustHookCommandInput {
        rel_path: ".githooks/pre-commit",
        parsed: &parsed,
    };
