...
fn block_contains_validation(block: &str) -> bool {
    let parsed = crate::app::rs::checks::hooks::shell::parse_script(block);
...
fn branch_covers_needle(branch: &str, needle: &str) -> bool {
    ...
    (block_contains_validation(&direct_branch) && block_mentions_config_trigger(&direct_branch, needle))
