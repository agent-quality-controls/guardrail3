...
use crate::app::core::discover::resolve_app_paths_from_member_dirs;
...
fn crate_checks(
    config: &crate::domain::config::types::CrateConfig,
) -> Option<&crate::domain::config::types::RustChecksConfig> {
