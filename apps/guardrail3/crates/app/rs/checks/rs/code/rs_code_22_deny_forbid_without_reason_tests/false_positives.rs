...
fn skips_reason_variants_on_same_line() {
    let content = "#[deny(clippy::panic)] // REASON: keep this API panic free\nfn one() {}\n#[forbid(clippy::expect_used)] //reason: worker retries handle fallibility\nfn two() {}\n#![deny(clippy::panic, clippy::expect_used)] // reason: root policy is documented\n";
...
fn inventories_forbid_unsafe_code_even_with_reason() {
    ...
    assert_eq!(results[0].severity, crate::domain::report::Severity::Info);
